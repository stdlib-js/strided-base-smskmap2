...
var smskmap2 = require( './../lib/main.js' );
...
tape( 'the function has an arity of 10', function test( t ) {
	t.strictEqual( smskmap2.length, 10, 'arity of 10' );
	t.end();
});
...
tape( 'the function supports an `x` stride', function test( t ) {
	...
	smskmap2( N, x, 2, y, 1, m, 1, z, 1, addf );
...
tape( 'the function supports a `y` stride', function test( t ) {
	...
	smskmap2( N, x, 1, y, 2, m, 1, z, 1, addf );
...
tape( 'the function supports a `mask` stride', function test( t ) {
	...
	smskmap2( N, x, 1, y, 1, m, 2, z, 1, addf );
...
tape( 'the function supports a `z` stride', function test( t ) {
	...
	smskmap2( N, x, 1, y, 1, m, 1, z, 2, addf );
...
tape( 'the function returns a reference to the destination array', function test( t ) {
	...
	out = smskmap2( x.length, x, 1, y, 1, m, 1, z, 1, addf );
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns the output array unchanged', function test( t ) {
	...
	smskmap2( -1, x, 1, y, 1, m, 1, z, 1, addf );
	t.deepEqual( z, expected, 'returns expected value' );

	smskmap2( 0, x, 1, y, 1, m, 1, z, 1, addf );
	t.deepEqual( z, expected, 'returns expected value' );
...
tape( 'the function supports negative strides', function test( t ) {
	...
	smskmap2( N, x, -2, y, -1, m, -1, z, -2, addf );
...
tape( 'the function supports complex access patterns', function test( t ) {
	...
	smskmap2( N, x, 2, y, -1, m, -2, z, -1, addf );
...
tape( 'the function supports view offsets', function test( t ) {
	...
	z1 = new Float32Array( z0.buffer, z0.BYTES_PER_ELEMENT*1 ); // begin at the 2nd element
